/*
 ...
 Source Host           : 192.168.127.139:3306
 Source Schema         : vhr
...
delimiter ;;
CREATE DEFINER=`ding`@`%` PROCEDURE `addDep`(in depName varchar(32),in parentId int,in enabled boolean,out result int,out result2 int)
begin
  declare did int;
...
delimiter ;;
CREATE DEFINER=`ding`@`%` PROCEDURE `deleteDep`(in did int,out result int)
begin
  declare ecount int;
  declare pid int;
  declare pcount int;
